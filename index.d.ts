...
// this file is copied and modified from https://raw.githubusercontent.com/microsoft/vscode/master/src/vs/vscode.d.ts
// License for this was included in the ThirdPartyOpenSourceNotice.txt
// copyright:
/*---------------------------------------------------------------------------------------------
...
declare module '@cloudide/plugin' {
    ...
    export namespace extensions {
         ...
         * @return An plug-in or `undefined`.
         */
        export function getExtension(pluginId: string): Extension<any> | undefined;
         ...
         * @return An plug-in or `undefined`.
         */
        export function getExtension<T>(pluginId: string): Extension<T> | undefined;
    ...
    export namespace window {
         ...
         */
        export interface CustomizableDialogEvent extends Event {
            /**
    ...
    */
     ...
     * @param scope Custom business scope.
     * @param action User behavior, eg. download, install, uninstalled.
     * @param data Behavioral data, eg. version, identifier, method, extension_name.
     */
